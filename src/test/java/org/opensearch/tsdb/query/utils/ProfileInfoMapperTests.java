...
public class ProfileInfoMapperTests extends OpenSearchTestCase {
    ...
    public void testExtractProfileInfo_WithValidDebugInfo() throws IOException {
        ...
        debugMap.put(ProfileInfoMapper.TOTAL_SAMPLES_POST_FILTER, 450L);
        ...
        debugMap.put(ProfileInfoMapper.LIVE_SAMPLES_POST_FILTER, 225L);
        debugMap.put(ProfileInfoMapper.CLOSED_SAMPLES_POST_FILTER, 225L);
        ...
        String expected = "{"
            ...
            + "\"total_samples_post_filter\":450,"
            + "\"live_samples_post_filter\":225,"
            + "\"closed_samples_post_filter\":225,"
    ...
    public void testExtractProfileInfo_WithMultipleStages() throws IOException {
        ...
        String expected = "{"
            ...
            + "\"total_samples_post_filter\":0,"
            + "\"live_samples_post_filter\":0,"
            + "\"closed_samples_post_filter\":0,"
    ...
    public void testExtractProfileInfo_WithAllMetrics() throws IOException {
        ...
        debugMap.put(ProfileInfoMapper.TOTAL_SAMPLES_POST_FILTER, 4500L);
        debugMap.put(ProfileInfoMapper.LIVE_SAMPLES_POST_FILTER, 2250L);
        debugMap.put(ProfileInfoMapper.CLOSED_SAMPLES_POST_FILTER, 2250L);
        ...
        String expected = "{"
            ...
            + "\"total_samples_post_filter\":4500,"
            + "\"live_samples_post_filter\":2250,"
            + "\"closed_samples_post_filter\":2250,"
